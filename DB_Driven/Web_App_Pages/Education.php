...
echo '<table bgcolor="#E4E8E8" width="763">
			<tr>
				<td>
					<p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Education History</strong> </font></p>
				</td>
			</tr>
		</table>		
	<table width="763" bgcolor="#E4E8E8" border="0">';
echo '<tr> 
		<td colspan="2"> <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif">List Education Information (beginning with highest degree earned).</font></p>
		...
		while($row=$result2->fetch(PDO::FETCH_BOTH)) {
			if ($row[9] == 'Y') {
				...
				echo'<table width="763" bgcolor="#E4E8E8">
						<tr>
							<td width="30%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Highest Degree</b></font></td>
						</tr>
					</table>';
			}
			if ($row[4] == '1900-01-01') {
			...
			echo '<table width="763" bgcolor="#E4E8E8">
				...
				<td width="15%">	
					<font size="1" face="Verdana, Arial, Helvetica, sans-serif">'.htmlspecialchars($row[6]).'</font>
				</td>
				<td width="15%">	
					<font size="1" face="Verdana, Arial, Helvetica, sans-serif">'.htmlspecialchars($row[7]).'</font>
				</td>
				<td width="15%">';
				if ($row[8] == 'Y') {	
						echo'<font size="1" face="Verdana, Arial, Helvetica, sans-serif">Graduated</font>';
				} else {
						echo'<font size="1" face="Verdana, Arial, Helvetica, sans-serif">Did Not Graduated</font>';
				}							
				echo'</td>
					<td align="center">
...
echo '<fieldset><legend><strong>Add Education</strong></legend>
	...
	if ($highestdegree == 'N') {	
		echo '<tr> 
			<td valign="top" width="160"> 
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Highest Degree?<font color="FF0000">*</font></strong></font>
			</td>
			<td width="351"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
	...
	echo '<tr valign="top"> 
			<td width="160"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Name of Institution<font color="FF0000">*</font></font></td>
			<td>
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
		...
		<tr valign="top"> 
			<td width="160"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">City<font color="FF0000">*</font></font></td>
	...
	echo '<tr> 
			...
			<td><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> OR If Education was out of the US, please select the Country</font></td>
		</tr>';
echo '<tr>
...
echo '<tr valign="top"> 
		<td width="160"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Attended From<font color="FF0000">*</font></font></td>
		<td>
			<font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
	...
	<tr> 
		<td width="160"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Attended To<font color="FF0000">*</font></font></td>
		<td>
			<font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
	...
	<tr> 
		<td width="160"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Major<font color="FF0000">*</font></font></td>
		<td><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
  ...
  <tr> 
  <tr valign="top"> 
    <td nowrap><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Degree<font color="FF0000">*</font></font></td>
	...
	<tr>
		<td valign="top" width="160"> 
			<font size="1" face="Verdana, Arial, Helvetica, sans-serif">Did You Graduate?</font><font color="FF0000">*</font>
		</td>
		<td width="351"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<INPUT TYPE="button" id="add_new_education" VALUE="Save Education" style="font-size:medium; font-family=Tahoma; color:green; border-radius:5px; padding: 5px 24px;">
		</td>
	</tr>
	</table>
	</fieldset>';
...
?>
		...
		<div>
			...
			<table width="100%" align="left" border="0" bgcolor="#eeeeee">
				<tr>
					<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Highest Degree?</strong></font></td>
				...
				<tr> 
					<td width="160" valign="top"> 
						<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Did You Graduate?</strong></font>
					</td>
					<td width="351"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
				...
				<tr> 
					<td width="160"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Name of Institution</font></td>
					<td width="351">
				...
				<tr> 
					<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Attended From</font></td>
					<td nowrap>
						<font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
				...
				<tr> 
					<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Attended To</font></td>
					<td nowrap>
						<font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
				...
				<tr> 
					<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Major</font></td>
					<td nowrap>
						<font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
				...
				<tr> 
					<td nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Degree</font></td>
