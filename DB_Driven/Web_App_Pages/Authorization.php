...
<p><font face="Verdana, Arial, Helvetica,sans-serif">I acknowledge receipt of the DISCLOSURE REGARDING BACKGROUND INVESTIGATION and A SUMMARY OF YOUR RIGHTS UNDER THE FAIR CREDIT REPORTING ACT and 
certify that I have read and understand both of those documents.  I hereby authorize the obtaining of “consumer reports” and/or “investigative consumer reports” by <?php echo $compname; ?>(“the Company”) 
at any time after receipt of this authorization and throughout my employment, if applicable.  
To this end, I hereby authorize, without reservation, any law enforcement agency, administrator, state or federal agency, institution, school or university (public or private), information service bureau, 
employer, insurance company or other party to furnish any and all background information requested by <b>Background Information Services, Inc., 1800 30th Street, Suite 204, Boulder, Colorado 80301, 800/433-6010, http://www.bisi.com</b> (“the Agency”), another outside organization acting on behalf of the Company, and/or the Company itself.  
I agree that a facsimile (“fax”) or electronic or photographic copy of this Authorization shall be as valid as the original.
...
<table align="center">
	<tr>
    	<td>
    		<p>
    			<br><INPUT TYPE="button" name="savesign" id="savesign" VALUE="Submit Data" style="font-size:medium; font-family=Tahoma; color:green; border-radius:5px; padding: 5px 24px;">
    		</p>
    	</td>
  	</tr>
</table>
			...
			success: function(valor) {
				...
				if (obj2 > '' ) {
					...
					var page = document.getElementById("pageno").value;
		 			window.location = nextpage+'.php?PersonID='+personid;	
				}	
				return;
			},	
