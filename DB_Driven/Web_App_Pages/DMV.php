	...
	if ($maxRecID > 0) { 
		...
		while($DMV = $dmv->fetch(PDO::FETCH_BOTH)) {	
			...
			echo '<table width="763" bgcolor="#E4E8E8"><tr> 
				<td align="left" width="30%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">'.htmlspecialchars($DMV[1]).'</font></td>
				<td align="left" width="30%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;'.htmlspecialchars($dateExpires).'</font></td>';
			if ($DMV[4] > '') {	
				echo '<td align="left" width="30%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.htmlspecialchars($DMV[4]).'</font></td>';
			} else {
				echo '<td align="left" width="30%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.htmlspecialchars($DMV[3]).'</font></td>';
			}
