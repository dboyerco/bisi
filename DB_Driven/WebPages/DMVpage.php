...
//		alert("In ajaxwebpages");
		...
		var url="../Ajax/ajax_dmv_page.php";
//	alert('URL is: '+url);	
...
//		document.getElementById("txtHint").innerHTML="Loading - Please Wait....";
	...
	function stateChanged() {
    	if(httpxml.readyState==4) {
			...
			var str = '<center><table id="tbl1" cellpadding="0" cellspacing="0" width=50%"><tbody><tr><th align="left">Limit By</th><th align="left">Limit #</th></tr><tr><td><select name="limitby" id="limitby"><option value="C">Current Driver License</option><option value="N">Number of Driver License</option></select></td><td><input name="limitno" id="limitno" value="'+myObject.data[0].LimitEntries+'" size="10"></input></td></tr></tbody></table></center><br />';
			
			str = str +	'<center><table id="tbl2" cellpadding="0" cellspacing="0" width="50%"><tbody><tr><th align="left">Display Msg</th></tr><tr><td><textarea id="displaymsg" rows="3" cols="100">'+myObject.data[0].Display_Msg+'</textarea></td></tr></tbody></table></center><br />';
			
			str = str +	'<center><table id="fldtbl" cellpadding="0" cellspacing="0" class="db-table" width="50%"><tbody><tr><th>Field Name</th><th>Field ID</th><th>Visible</th><th>Required</th></tr>';
//			alert(myObject.data.length);
			for(i=0;i<myObject.data.length;i++) { 
				str = str +	'<tr><td><input name="fldname" value="'+myObject.data[i].FLD1+'" readonly size="50"></input></td><td><input name="fldid9" value="'+myObject.data[i].FLD1_ID+'" readonly size="15"></input></td><td align="center"><select name="fldvisible" disabled><option value="N">N</option><option value="Y">Y</option></select></td><td align="center"><select name="fldrequired" disabled><option value="N">N</option><option value="Y">Y</option></select></td></tr>';
				str = str +	'<tr><td><input name="fldname" value="'+myObject.data[i].FLD2+'" readonly size="50"></input></td><td><input name="fldid9" value="'+myObject.data[i].FLD2_ID+'" readonly size="15"></input></td><td align="center"><select name="fldvisible" disabled><option value="N">N</option><option value="Y">Y</option></select></td><td align="center"><select name="fldrequired" disabled><option value="N">N</option><option value="Y">Y</option></select></td></tr>';
				str = str +	'<tr><td><input name="fldname" value="'+myObject.data[i].FLD3+'" readonly size="50"></input></td><td><input name="fldid9" value="'+myObject.data[i].FLD3_ID+'" readonly size="15"></input></td><td align="center"><select name="fldvisible" disabled><option value="N">N</option><option value="Y">Y</option></select></td><td align="center"><select name="fldrequired" disabled><option value="N">N</option><option value="Y">Y</option></select></td></tr>';
				str = str +	'<tr><td><input name="fldname" value="'+myObject.data[i].FLD4+'" readonly size="50"></input></td><td><input name="fldid9" value="'+myObject.data[i].FLD4_ID+'" readonly size="15"></input></td><td align="center"><select name="fldvisible" disabled><option value="N">N</option><option value="Y">Y</option></select></td><td align="center"><select name="fldrequired" disabled><option value="N">N</option><option value="Y">Y</option></select></td></tr>';
			}	
				...
				for(s=0;s<myObject.data.length;s++) { 
					switch(i){
						case 1:			
							...
							break;
						case 2:			
							tableRows[i].cells[3].firstChild.value = myObject.data[s].FLD2_Visible;
...
<body>			
	...
	<table width="100%">
			<tr>
				...
				<td>&nbsp;</td>
				<td align="center">
					<font size="6" face="tahoma" color="blue">Edit DMV Page</font>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
...
//			alert(tableRows[i].cells[0].firstChild.value+" - "+tableRows[i].cells[1].firstChild.value);
		...
		$.ajax({
			type: "POST",
			url: "../Ajax/ajax_save_dmv_page.php", 
