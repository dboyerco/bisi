...
//		alert("In ajaxwebpages");
		...
		var url="../Ajax/ajax_bank_page.php";
//	alert('URL is: '+url);	
...
//			alert(myObject.data.length);
			var str = '<center><table id="tbl1" cellpadding="0" cellspacing="0" width="75%"><tbody><tr><th align="left">Limit By</th><th align="left">Limit #</th></tr><tr><td><select name="limitby" id="limitby"><option value="C">Current Bank</option><option value="N">Number of Banks</option></select></td><td><input name="limitno" id="limitno" value="'+myObject.data[0].LimitEntries+'" size="10"></input></tr></tbody></table><br />';
...
<body>			
	...
	<div id="headerdiv" style="color:#000000; BORDER-TOP: #000000 0px solid; BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; OVERFLOW: false; BORDER-LEFT: #000000 0px solid; PADDING-TOP: 0px; BORDER-BOTTOM: #000000 0px solid; HEIGHT:150px">
	<center>
	<table width="50%">
			<tr>
				<td align="center">
					<font size="6" face="tahoma" color="blue">Edit Bank Page</font>
				</td>
			</tr>
		</table>
	</center>	
...
//			alert(tableRows[i].cells[0].firstChild.value+" - "+tableRows[i].cells[1].firstChild.value+" - "+tableRows[i].cells[2].firstChild.value);
		...
		$.ajax({
			type: "POST",
			url: "../Ajax/ajax_save_bank_page.php", 
