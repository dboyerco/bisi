...
//		alert("In ajaxwebpages");
		...
		var url="../Ajax/ajax_reference_page.php";
//	alert('URL is: '+url);	
...
//		document.getElementById("txtHint").innerHTML="Loading - Please Wait....";
	...
	function stateChanged() {
    	if(httpxml.readyState==4) {
			...
			var str = '<table id="tbl1" cellpadding="0" cellspacing="0" width="75%"><tbody><tr><th align="left">Limit By</th><th align="left">Limit #</th></tr><tr><td><select name="limitby" id="limitby"><option value="N">Number of References</option><option value="Y">Years</option></select></td><td><input name="limitno" id="limitno" value="'+myObject.data[0].LimitEntries+'" size="10"></input></td></tr></tbody></table><br />';
...
<body>			
	...
	<table width="50%">
			<tr>
				<td align="center">
					<font size="6" face="tahoma" color="blue">Edit Reference Page</font>
				</td>
			</tr>
		</table>
	</center>	
...
//			alert(tableRows[i].cells[0].firstChild.value+" - "+tableRows[i].cells[1].firstChild.value);
		...
		$.ajax({
			type: "POST",
			url: "../Ajax/ajax_save_reference_page.php", 
