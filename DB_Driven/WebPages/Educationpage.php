...
//		alert("In ajaxwebpages");
		...
		var url="../Ajax/ajax_education_page.php";
//	alert('URL is: '+url);	
...
//		document.getElementById("txtHint").innerHTML="Loading - Please Wait....";
	...
	function stateChanged() {
    	if(httpxml.readyState==4) {
			...
			var str = '<table id="tbl1" cellpadding="0" cellspacing="0" width="75%"><tbody><tr><th align="left">Limit By</th><th align="left">Limit #</th></tr><tr><td><select name="limitby" id="limitby"><option value="C">Current Address</option><option value="N">Number of Address</option><option value="Y">Years</option></select></td><td><input name="limitno" id="limitno" value="'+myObject.data[0].LimitEntries+'" size="10"></input></td></tr></tbody></table><br />';
			str = str + '<table id="tbl1" cellpadding="0" cellspacing="0" width="75%"><tbody><tr><th align="left">Display Msg</th></tr><tr><td><textarea id="displaymsg" rows="3" cols="125">'+myObject.data[0].Display_Msg+'</textarea></td></tr></tbody></table><br />';
...
<body>			
	...
	<table width="50%">
			<tr>
				<td align="center">
					<font size="6" face="tahoma" color="blue">Edit Education Page</font>
				</td>
			</tr>
		</table>
	</center>	
...
//			alert(tableRows[i].cells[0].firstChild.value+" - "+tableRows[i].cells[1].firstChild.value);
		...
		$.ajax({
			type: "POST",
			url: "../Ajax/ajax_save_education_page.php", 
