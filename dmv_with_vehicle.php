	...
	while($DMV = $dmv->fetch(PDO::FETCH_BOTH)) {
		...
		echo '	<div class="cell small-3 right">
						...
						<div class="cell small-3">
							' . htmlspecialchars($DMV[6]) . '
						</div>
						<div class="cell small-3">
							' . htmlspecialchars($DMV[7]) . '
						</div>
						<div class="cell small-3">
							' . htmlspecialchars($DMV[8]) . '
						</div>
						<div class="cell small-3">
							' . htmlspecialchars($DMV[9]) . '
						</div>
						<div class="cell small-12">
							<hr>
						</div>';
		...
		$.ajax({
			...
			success: function(valor) {
				...
				if(obj2) {
					...
					$("#vmake").val(obj2.Vehicle_Make);
					$("#vmodel").val(obj2.Vehicle_Model);
					$("#vyear").val(obj2.Vehicle_Year);
					$("#vplate").val(obj2.Vehicle_License_Plate);
