...
<p><font face="Verdana, Arial, Helvetica,sans-serif">I acknowledge receipt of the DISCLOSURE REGARDING BACKGROUND INVESTIGATION and A SUMMARY OF YOUR RIGHTS UNDER THE FAIR CREDIT REPORTING ACT and certify that 
I have read and understand both of those documents. I hereby authorize the obtaining of “consumer reports” and/or “investigative consumer reports” by <?php echo $compname; ?>(“the Company”) 
at any time after receipt of this authorization and throughout my occupancy, if applicable. To this end, I hereby authorize, without reservation, any law enforcement agency, administrator, 
state or federal agency, institution, school or university (public or private), information service bureau, employer, insurance company or other party to furnish any and all background information 
requested by Background Information Services, Inc., 1800 30th Street, Suite 204, Boulder, Colorado 80301, 800/433-6010, http://www.bisi.com (“the Agency”), another outside organization acting on behalf 
of the Company, and/or the Company itself. I agree that a facsimile (“fax”) or electronic or photographic copy of this Authorization shall be as valid as the original. 
I agree that my electronic signature, acknowledgement, acceptance, and/or authorization are the equivalent of my handwritten signature. 
<br /><br /> 
<b>California applicants and employees only:</b>  By signing below, you also acknowledge receipt of the NOTICE REGARDING BACKGROUND INVESTIGATION PURSUANT TO CALIFORNIA LAW.  Please check this box if you would like to receive a copy of an investigative consumer report at no charge if one is obtained by the Company whenever you have a right to receive such a copy under California law.<br /><br />
