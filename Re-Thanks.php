...
if ($noemail == 'N') {
	...
	$hellofrom = $cname." Application Submission <info@bisi.com>";
	$helloto = $Semail;
#	$helloto = "";
...
#	$hellobody .= '<tr><td>&nbsp;<td></tr>';
	...
	$sql = "update App_Person set Submitted = 'Y', CertifiedBy = :CertifiedBy, CertifiedDate = :CertifiedDate, Status = :Status, Status_Date = :Status_Date where PersonID = :PersonID";
	$updt=$dbo->prepare($sql);
	$updt->bindValue(':PersonID', $PersonID);
