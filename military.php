	...
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			$(document).ready(function() {
				...
				if (Military > 0) { 
//				var Military = getCookie('Military');
...
<p><img src="files/hdspacer.gif"></p>
	...
	<table bgcolor="#E4E8E8" width="763" border="0">
		...
		<tr> 
			<td width="350"><font size="1"><b>Have you had any military service within the last 7 years?</b></font></td>
			<td>
				<font size="1"> 
...
echo '<table bgcolor="#E4E8E8" width="763" border="0">
		<tr>
			<td>
				<p><font size="2"><strong>Military Service Information</strong> </font></p>
			</td>
		</tr>	
		<tr> 
			<td colspan="2"><font size="2">Please enter your Military service information.</font></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
	</table>';
	if ($maxMilID > 0) { 
		...
		while($row=$result2->fetch(PDO::FETCH_BOTH)) {
			...
			echo '<table width="763" bgcolor="#E4E8E8">
				<tr>
					<td width="30%"><font size="1">'.htmlspecialchars($row[1]).'</font></td>
					<td width="10%"><font size="1">'.htmlspecialchars($row[2]).'</font></td>
					<td width="10%"><font size="1">'.htmlspecialchars($startdate).'</font></td>			
					<td width="30%"><font size="1">'.htmlspecialchars($termdate).'</font></td>';
			...
			while($row3=$result3->fetch(PDO::FETCH_BOTH)) {
				echo '<td width="5%"><a href="https://proteus.bisi.com/bisi_uploads/'.$row3[0].'" target="blank""><span style="font-size:small; font-family=Tahoma; color:#000000;"><img src="https://proteus.bisi.com/Level3/images/DocumentBlue.png" height="15" width="15" alt="Display Military Doc" title="Display Military Doc"></span></a></td>';
			}
			$cnt++;	
...
echo '<fieldset><legend><strong>Add Military Information</strong></legend>
		<table width="100%" bgcolor="#E4E8E8">
			<tr>
				<td><font size="2"><b>Please fax a copy of your DD Form 214 to 303-442-1004 or upload it <a href="#openPhotoDialog">here</a></b></font>
				</td>
			</tr>	
			<tr><td>&nbsp;</td></tr>
		</table>
	...
	echo '<tr valign="top"> 
			<td width="160"><font size="1">Branch<font color="FF0000">*</font></font></td>
			<td>
				<font size="1"> 
		...
		<tr valign="top"> 
			<td width="160"><font size="1">Current/Most Recent Rank<font color="FF0000">*</font></font></td>
			<td>
				<font size="1"> 
		...
		<tr valign="top"> 
			<td width="160"><font size="1">Start Date<font color="FF0000">*</font></font></td>
			<td><font size="1"> 
				<input name="newstartdate" id="newstartdate" size="10" maxlength="10" placeholder="mm/dd/yyyy" onKeyUp="return frmtdate(this,\'up\')"></font>
			</td>
		</tr>
		<tr> 
			<td><font size="1">Termination Date<font color="#FF0000">*</font></font></td>
			<td nowrap>
				<font size="1"> 
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<INPUT TYPE="button" id="add_new_military" VALUE="Save Military Info" style="font-size:medium; font-family=Tahoma; color:green;">
			</td>
		</tr>
	</table>
	</fieldset>';
...
echo "<INPUT TYPE=\"hidden\" NAME=\"PersonID\" ID=\"PersonID\" VALUE=\"$PersonID\">
	  ...
	  <INPUT TYPE=\"hidden\" NAME=\"UploadType\" ID=\"UploadType\" VALUE=\"Military\">";
...
?>
		...
		<div>
			...
			<table width="100%" align="left" border="3" bgcolor="#eeeeee">
				<tr valign="top"> 
					<td width="160"><font size="2">Branch<font color="FF0000">*</font></font></td>
					<td>
						<font size="2"> 
				...
				<tr valign="top"> 
					<td width="160"><font size="2">Current/Most Recent Rank<font color="FF0000">*</font></font></td>
					<td><font size="2"> 
						<input name="dlgmilrank" id="dlgmilrank" value="" size="30"></font>
					</td>
				</tr>
				<tr valign="top"> 
					<td width="160"><font size="2">Start Date<font color="FF0000">*</font></font></td>
					<td><font size="2"> 
						<input name="dlgstartdate" id="dlgstartdate" size="10" maxlength="10" placeholder="mm/dd/yyyy" onKeyUp="return frmtdate(this,'up')"></font>
					</td>
				</tr>
				<tr> 
					<td><font size="2">Termination Date<font color="#FF0000">*</font></font></td>
					<td nowrap>
						<font size="2"> 
 ...
 <script language="JavaScript" type="text/javascript">
	...
	$( "#add_new_military" ).click(function() {	
		...
		if (document.getElementById("newmiltermdate").value > '') {
			if (!isValidDate('newmiltermdate')) {
				$('#newmiltermdate').focus();
		...
		if (!isValidDiff(newstartdate,newmiltermdate)) {
			$('#newstartdate').focus();
			alert("From Start Date can not be greater than the Termination Date");
			return false;
		}	
 	...
 	$("#save_military").click(function() {	
		...
		if (document.getElementById("dlgmiltermdate").value > '') {
			if (!isValidDate('dlgmiltermdate')) {
				$('#dlgmiltermdate').focus();
				alert("Invalid Termination Date");
				return false;
			} else {					
		...
		if (!isValidDiff(dlgstartdate,dlgmiltermdate)) {
			$('#dlgmiltermdate').focus();
			alert("Start Date can not be greater than the Termination Date");
			return false;
		}	
