...
echo '				<div class="cell small-12"><hr></div>
					...
					<div class="grid-x margins">
						<div class="cell small-12 medium-6 padding-bottom">
							<input name="save_and_stay" class="float-center" id="save_and_stay" type="button" value="Save and Exit">
						</div>
						<div class="cell small-12 medium-6">
							<input name="save_and_go" class="float-center" id="save_and_go" type="button" value="Save and Continue">
						</div>';
					if($No_Email == 'N') {
						echo '<div class="cell small-12">
								<strong>Note: </strong>You can return to this Application Portal at any time by clicking on the link in the email that was sent to you. All the data you have saved will be displayed when you return.<br>
							</div>';
					}

echo '					<input type="hidden" name="AliasID" id="AliasID">
...
//		$("#fbdate").val($("#birthdate_year").val() + '-' + $("#birthdate_month").val() + '-' + $("#birthdate_day").val());
		$("#fbdate").val($("#birthdate_month").val() + '/' + $("#birthdate_day").val()  + '/' +  $("#birthdate_year").val());
	}
...
//					var ssn = '111-11-1111';	
		...
		if(packagename == 'caps') {
			...
			if($("#gender3").prop('checked')) {
				var gender = 'Transgender (Identifies as Woman)';
			}
			if($("#gender4").prop('checked')) {
				var gender = 'Transgender (Identifies as Man)';
			}
			if($("#gender5").prop('checked')) {
				var gender = 'Unknown';
			}			
			...
			if($("#race1").prop('checked')) {
				race_AI_AN = 'Y';
			}
			if($("#race2").prop('checked')) {
				race_Asian = 'Y';
			}
			if($("#race3").prop('checked')) {
				race_B_AA = 'Y';
			}
			if($("#race4").prop('checked')) {
				race_HN_PI = 'Y';
			}
			if($("#race5").prop('checked')) {
				race_H_L = 'Y';
			}
			if($("#race6").prop('checked')) {
				race_ME_NA = 'Y';
			}
			if($("#race7").prop('checked')) {
				race_White = 'Y';
			}
			if (race_AI_AN == 'N' && race_Asian == 'N' && race_B_AA == 'N' && race_HN_PI == 'N' && race_H_L == 'N' && race_ME_NA == 'N' && race_White == 'N' && moveOn) {
				$("#race1").focus();
		...
		if(packagename == 'caps') {
			if($("#busphone").val() > '' || !moveOn) {
				var busphone = $("#busphone").val();
			}
			else {
				$("#busphone").focus();
				alert("Please enter your work phone number or N/A if you don't have one");
				return false;
			}
			if($("#homephone").val() > '' || !moveOn) {
				var homephone = $("#homephone").val();
			}	
			else {
				$("#homephone").focus();
				alert("Please enter your home phone number or N/A if you don't have one");
				return false;
			}
			if($("#cellphone").val() > '' || !moveOn) {
				var cellphone = $("#cellphone").val();
			}
			else {
				$("#cellphone").focus();
				alert("Please enter a cell phone number or N/A if you don't have one");
				return false;
			}			
		}	 
		else {	
			if($("#busphone").val() == '' && $("#homephone").val() == '' && $("#cellphone").val() == '' && moveOn) {
				$("#busphone").focus();
		...
		if (packagename == 'caps') {
			if($("#workemail").val() > '' || !moveOn) {
				var workemail = $("#workemail").val();
			}
			else {
				$("#workemail").focus();
				alert("Work Email Address is required. Enter N/A if you don't have one ");
				return false;
			}
		} else {
			var workemail = '';
