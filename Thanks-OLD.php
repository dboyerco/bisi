<?php
#echo '<form method="post" action="" name="ALCATEL">';
...
while($alias = $row->fetch()) {
	...
	$hellobody2 .= "	$alias[3] $alias[2] 	Last used: $lastused\n";
	$aka++;
}
...
if($noemail == 'N' || $noemail == 'S') {
	...
	$addresses = explode(",", $Semail);
	$mailbody = '<html><body><table style="border:5px solid black; border-radius:10px;">';

	if($parentdocneeded) {
		$mailbody .= '<tr><td><span style="font-size:medium; font-family=Tahoma; color:#000000;">'.$fname.'&nbsp;'.$lname.' has completed the authorization for their background check but neededs the Parent Release form. You can <a href="https://proteus.bisi.com/'.$appname.'/HR">Click Here</a> to view applicants data.</span></td></tr>';
	}
	else {
		$mailbody .= '<tr><td><span style="font-size:medium; font-family=Tahoma; color:#000000;">'.$fname.'&nbsp;'.$lname.' has completed the authorization for their background check and is Ready to Screen. Please <a href="https://proteus.bisi.com/'.$appname.'/HR">Click Here</a> to submit the order to BIS.</span></td></tr>';
	}

	$mailbody .= '<tr><td>&nbsp;</td></tr>';
	$mailbody .= '<tr><td><span style="font-size:medium; font-family=Tahoma; color:#000000;">If you have questions or need assistance, please contact us at <a href="mailto:service@bisi.com">Service@BISI.com</a> or 800-433-6010. We are in the office Monday - Friday, 8:00am - 5:00 pm MT.</span></td></tr>';
	$mailbody .= '<tr><td>&nbsp;</td></tr>';
	$mailbody .= '<tr><td><span style="font-size:medium; font-family=Tahoma; color:#000000;">Thank you!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$PersonID.'</span></td></tr>';
	$mailbody .= '</table></body></html>';

	$mail = new PHPMailer;
	$mail->setFrom("service@bisi.com", $cname . " Application Submission");
	for($i=0; $i<count($addresses); $i++){
   		$mail->addAddress($addresses[$i]);
	}
	$mail->addBCC("dennis.boyer@bisi.com", "Dennis Boyer");
	$mail->Subject = $compname . " Application Submission for $fname $lname";
...
#		$Comment = $fname.' '.$lname.' has completed the online web app and is ready to be submitted to BIS';
	...
	if($Status == 'Ready to Screen') {
		echo '<div class="cell small-12">
				<span class="sub-heading"><strong>Thank you for your submission to ' . $compname . '</strong></span>
			</div>
			<div class="cell small-12">
				<span class="sub-heading">Submission Complete</span>
			</div>';
	}
	else {
		echo '<div class="cell small-12">
			...
			<div class="cell small-12">
				<span class="sub-heading"><strong>Parent Release form is still needed.</strong></span>
			</div>
			<div class="cell small-12">
				<span class="sub-heading"><strong><a href="#openPhotoDialog">Click to Upload the Document.</a></strong></span>
			</div>';
	}
...
#		$Comment = $fname.' '.$lname.' was submitted to BIS for a background check';
	if($OKSend) {
		...
		echo '<div class="cell small-12">
				<span class="sub-heading"><strong>Thank you for your submission.<br />' . $fname . ' ' . $lname . ' submitted to BIS </strong></span>
			</div>
			<div class="cell small-12">
				<span class="sub-heading">Submission Complete</span>
			</div>';
		...
		echo '<div class="cell small-12">
				<span class="sub-heading"><strong>Thank you for your submission.</strong></span>
			</div>
			<div class="cell small-12">
				<span class="sub-heading"><strong>Parent Release form is still needed.</strong></span>
			</div>			
