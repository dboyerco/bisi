...
#		  		&nbsp;&nbsp;<a href="#" onclick="clearempSign('.$PersonID.');">Clear</a>
	...
	if($I9Cnt > 0) {
		...
		echo '						<input type="checkbox" name="nohelp" id="nohelp" onclick="setnohelp()"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
											I did not use a preparer or translator&nbsp;&nbsp;&nbsp;&nbsp;</font>
											<input type="checkbox" name="needhelp" id="needhelp" onclick="setneedhelp()"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">';
	}
...
//		alert('In getsig');
	...
	function chkrequired() {
		...
		if(document.getElementById("citizen").checked || document.getElementById("noncitizen").checked || document.getElementById("legalresident").checked || document.getElementById("alien").checked) {
		...
		if(document.getElementById("alien").checked) {
			...
			if(/\S/.test(document.getElementById("aliennumber").value) || /\S/.test(document.getElementById("admissionnumber").value) || (/\S/.test(document.getElementById("foreignpassport").value) && /\S/.test(document.getElementById("countryofissuance").value))) {
				$('#tblcitizen').removeClass('requiredInput');
  			$('#tblcitizen').addClass('goodInput');
				$('#tblalien').removeClass('requiredInput');
  			$('#tblalien').addClass('goodInput');
