...
?>		
		...
		<link type="text/css" rel="stylesheet" href="StyleCSS/section1_table.css" />
	 ...
	 <table bgcolor="#ffffff" border="1" cellpadding="0" cellspacing="0" width="975">	
		<tr>
			<td>
				...
				<input name="employeesignature" id="employeesignature" class="requiredInput" value="'.htmlspecialchars($employeesignature).'" size="55" maxlength="55" readonly><br />		
...
//		alert("In save");
		...
		if (document.getElementById("needhelp").checked == true) {
			...
			var Preparer_Signature = 'Signature/PersonID-'+PersonID+'Prep.png';
